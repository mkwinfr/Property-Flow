...
- Added `.env` file with `VITE_API_BASE_URL=https://api.propertysuite.net/api` (override locally as needed, e.g. `http://localhost:4000/api`)
...
**API Integration**: Board fetches from `${VITE_API_BASE_URL}/make-ready-board`
