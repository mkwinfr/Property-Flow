...
export function MyWorkPage() {
  ...
  return <div className="page-stack my-work-page">
    <section className="page-heading page-heading--my-work"><div><p className="eyebrow">{property?.name}</p><h1>My work</h1><p>Assigned Make Readies, current priorities, and returned work in one focused queue.</p></div><span className="my-work-person"><UserRoundCheck /><span><strong>{user?.name}</strong><small>{user?.roles.join(" · ")}</small></span></span></section>
